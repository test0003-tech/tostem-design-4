...
export const mainNavigation: NavSection[] = [
  {
    ...
    children: [
      ...
      { label: "Our Purpose & Behaviour", href: "#purpose" },
      { label: "LIXIL Window System", href: "#lixil" },
    ],
  },
  {
    label: "WHY TOSTEM",
    ...
    children: [
      ...
      { label: "Pre-Engineered System Windows", href: "#pre-engineered" },
      { label: "Quality Assurance", href: "#quality-assurance" },
      { label: "Anodized Aluminum", href: "#anodized-aluminum" },
      { label: "Soundproof Insulated", href: "#soundproof" },
      { label: "System Aluminum Windows", href: "#system-aluminum" },
    ],
  },
  {
    label: "OUR PRODUCTS",
    ...
    columns: [
      {
        title: "Windows",
        items: [
          { label: "Sliding Windows", href: "#sliding-windows" },
          { label: "Casement Windows", href: "#casement-windows" },
          { label: "Awning Windows", href: "#awning-windows" },
          { label: "Fixed Windows", href: "#fixed-windows" },
          { label: "Tilt-Slide Windows", href: "#tilt-slide-windows" },
          { label: "Mix Windows", href: "#mix-windows" },
        ],
      },
      {
        title: "Doors",
        items: [
          ...
          { label: "Swing Doors", href: "#swing-doors" },
          { label: "Folding Doors", href: "#folding-doors" },
          { label: "Hanging Doors", href: "#hanging-doors" },
          { label: "Partition Doors", href: "#partition-doors" },
          { label: "Entrance Doors", href: "#entrance-doors" },
        ],
      },
      {
        title: "Interior",
        items: [
          { label: "Hanging", href: "#interior-hanging" },
          { label: "Partition", href: "#interior-partition" },
        ],
      },
      {
        title: "Exterior",
        items: [
          { label: "Entrance", href: "#exterior-entrance" },
          { label: "Gate", href: "#exterior-gate" },
          { label: "Fence", href: "#exterior-fence" },
          { label: "Facade", href: "#exterior-facade" },
        ],
      },
    ],
  },
  {
    label: "TOSTEM EXPERIENCE",
    href: "#experience",
    children: [
      { label: "TADA Awards", href: "#tada-awards" },
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Planning A System Window", href: "#planning" },
      { label: "Pre-Engineering", href: "#pre-engineering-knowledge" },
    ],
  },
  {
    label: "REACH US",
